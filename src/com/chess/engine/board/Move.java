...
public abstract class Move {
    ...
    public Board execute() {    //returns a new board when a move is made, does not return existing board
        final Builder builder = new Builder();
        for (final Piece piece : this.board.currentPlayer().getActivePieces()){
            //All pieces that aren't moved will be set in the same place for the new board
            if(!this.movedPiece.equals(piece)){
                builder.setPiece(piece);
            }
        }
        //Setting opponent's pieces
        for (final Piece piece : this.board.currentPlayer().getOpponent().getActivePieces()){
            builder.setPiece(piece);
        }
        //Moving the moved piece
        builder.setPiece(this.movedPiece.movePiece(this));
        //Setting the MoveMaker to the opponent (i.e. setting from WHITE to BLACK)
    ...
    public static class MoveFactory{
        ...
        //Given a board and from and to coordinate, return the move
